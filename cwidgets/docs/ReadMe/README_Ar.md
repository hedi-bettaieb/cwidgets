دليل المستخدم - مكتبة CWidgets V0.1.1:
...
شكرا على اهتمامك و تقديرك للمجهود الذي بذلته في المكتبة .
أو لا لو قمت بتثبيت المكتبة أدعوك لازالتها ثم اعادة تثبيتها .
اكتشفت انني نسيت سطر غير صحيح في أحد السكريبتات فقمت بإصلاح الخطأ و أعدت رفعها على pip .
الاصدار الجديد الصحيح هو 0.1.1 
نعم 6 عناصر ترث من عناصر qt أصلية و بالتالي كل الدوالي تواصل عملها مع اضافة تحسينات في التوافقية .
بالنسبة ل cmessage box لم استخدم thread كل ما قمت به هو اضافة مؤقت timeout .
و استخدمتها في برنامجي easy subtitle و ما ضربتش معايا .
العنصر الوحيد الذي لم يرث من qt هو ctextedit .
لأن qtextedit  لا يرجى منه خيرا .
richedit win 32 المتوافق افتراضيا أدمجته في نافذة qt .
و هذا هو التعقيد بعينه و أصعب شيء في المكتبة كلها و هذا الامر وحده أخذ تقريبا شهرا كاملا في البحث عن حلول و تطلب الامر اكثر من 70 تجربة لعدد كبير من الحلول لتنجح العملية في الأخير .
كان عملا شاقا جدا و يتطلب صبر أيوب مضروب في 1000 .
حاولت قدر الامكان استخدام نفس دوالي ) من حيث الاسماء( qt مثال 
settext, text, toplaintext, setfocus, settextcolor, setbackgroundcolor, setalignment, setreadonly etc....
tohtml وضعتها ثم الغيتها لان الدالة التي وضعتها كانت بدائية جدا .
قلت في اصدار قادم اشتغل عليها بشكل جيد .
أما الاشياء التي ذكرتها فبصراحة لا أعرفها و ان شاء الله نتعاون في الاصدار القادم ندرجها .
